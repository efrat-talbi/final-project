    ...
    chapters: [
      {
        ...
        title: "הרחם המשוטט",
        period: "יוון העתיקה",
        desc: "את האזכור המוקדם ביותר להיסטריה נהוג לייחס להיפוקרטס, אבי מדע הרפואה המודרני. היפוקרטס הושפע מהתפיסה הרווחת בזמנו של  מהות אישה — מין מוטציה, גבר שהתקלקל. בעוד שלגוף הגבר הוא התייחס כמכלול של איברים, כשאישה חלתה היתה זו תמיד אשמת הרחם. אם אישה משתעלת, זה משום שהרחם נצמד לקיבה שלה, אם היא חווה לחץ בחזה הוא התיישב על הלב, וכן הלאה. תיאוריית הרחם של היפוקרטס היוותה את הבסיס לרפואת הנשים במשך דורות רבים, ועד היום עולם הרפואה סובל מפיגור משמעותי בכל הנוגע להבנת הגוף הנשי."
      },
      {
        id: "dark-ages",
        title: "כלי של השטן",
